...
- [[projects/project-davinci-code]] — 다빈치코드 웹 보드게임 (v1 배포 완료, v2 진행 중)

## Decisions

- [[decisions/2026-06-18-game-policy]] — 추리 패널티·관전·4인 고정·조커·모바일 UX
- [[decisions/2026-06-19-server-v2-pre-impl]] — 서버 v2 JWT·채팅·disconnect·DB 결정
...
- [[dev-tasks/server-v2-phase-a-db]] — 서버 v2 Phase A DB 인프라 (진행 중)
